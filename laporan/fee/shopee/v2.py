...
def generate_fee(shp_file, df_fee, df_adjust):
    logging.info("Generate Fee Shopee from {0} ({1} rows)".format(shp_file, len(df_fee)))
    ...
    df_fee = df_fee[['No. Pesanan', 'Harga Asli Produk', 'Jumlah Pengembalian Dana ke Pembeli', 'Total Diskon Produk', 'Ongkir Dibayar Pembeli', 'Diskon Ongkir Ditanggung Jasa Kirim',
                     ...
                     'Biaya Transaksi', 'Biaya Administrasi', 'Biaya Layanan (termasuk PPN 11%)', 'Total Penghasilan']]
    df_fee.columns = ['Invoice', 'Harga Asli Produk', 'Jumlah Pengembalian Dana ke Pembeli', 'Total Diskon Produk', 'Ongkir Dibayar Pembeli', 'Diskon Ongkir Ditanggung Jasa Kirim',
                      'Gratis Ongkir dari Shopee', 'Ongkir yang Diteruskan oleh Shopee ke Jasa Kirim', 'Ongkos Kirim Pengembalian Barang',
                      'Biaya Transaksi', 'Biaya Administrasi', 'Biaya Layanan (termasuk PPN 11%)', 'Nominal Remit']
    ...
    df_fee['Kerugian Tambahan (Fee)'] = -(df_fee['Jumlah Pengembalian Dana ke Pembeli'] + df_fee['Biaya Transaksi'] + df_fee['Biaya Administrasi'] + df_fee['Biaya Layanan (termasuk PPN 11%)'])
