...
def generate_bisafee(shp_file, df_fee, df_adjust):
    ...
    df_fee = df_fee[['No. Pesanan', 'Harga Asli Produk', 'Jumlah Pengembalian Dana ke Pembeli', 'Total Diskon Produk', 'Ongkir Dibayar Pembeli', 'Diskon Ongkir Ditanggung Jasa Kirim',
                     'Gratis Ongkir dari Shopee', 'Ongkir yang Diteruskan oleh Shopee ke Jasa Kirim', 'Biaya Administrasi', 'Biaya Layanan (termasuk PPN 11%)', 'Total Penghasilan']]
    df_fee.columns = ['Invoice', 'Harga Asli Produk', 'Jumlah Pengembalian Dana ke Pembeli', 'Total Diskon Produk', 'Ongkir Dibayar Pembeli', 'Diskon Ongkir Ditanggung Jasa Kirim',
                      'Gratis Ongkir dari Shopee', 'Ongkir yang Diteruskan oleh Shopee ke Jasa Kirim', 'Biaya Administrasi', 'Biaya Layanan (termasuk PPN 11%)', 'Nominal Remit']

    df_fee['Potongan Pembayaran (Fee)'] = -(df_fee['Ongkir yang Diteruskan oleh Shopee ke Jasa Kirim'])
    df_fee['Keuntungan Tambahan (Fee)'] = (df_fee['Ongkir Dibayar Pembeli'] + df_fee['Diskon Ongkir Ditanggung Jasa Kirim'] + df_fee['Gratis Ongkir dari Shopee'] + df_fee['Ongkir yang Diteruskan oleh Shopee ke Jasa Kirim'])
